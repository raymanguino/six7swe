    ...
    <header className="fixed top-0 left-0 right-0 bg-white/50 dark:bg-gray-800/50 shadow-md z-50 font-mono backdrop-blur-sm">
      <nav className="container mx-auto max-w-screen-2xl pl-6 pr-6 py-4">
        <div className="flex flex-col items-start gap-2">
          <div
            className={`w-full overflow-hidden transition-all duration-300 ease-in-out flex flex-col items-start gap-1 sm:flex-row sm:items-center sm:justify-between ${
              atTop ? 'max-h-24 sm:max-h-12 opacity-100' : 'max-h-0 opacity-0'
            }`}
          >
            <a
              href="#home"
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 shrink-0">
              <span className="sm:whitespace-nowrap">Open to Senior+ roles at Series A-D companies</span>
              <span
