# 67SWE - Job Application Management Platform

A modular monolith application for managing job applications with Fastify backend and Supabase (PostgreSQL) database.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/YOUR_USERNAME/67swe.git
   cd 67swe
   ```
